...
<?php
  ...
  {
  // checks for corresponding username and password
    while($row = $result->fetch_assoc()) 
    {
      if($_POST["username"]==$row["UserName"])
      {
        ...
        { 
          //in case of correct password and username
          $flag=1;
          break;
        }  
      }
  ...
  {
    //correct password and username gives option to visit notice board(or to change access levels in case of an admin
